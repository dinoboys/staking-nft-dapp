...
import "../interfaces/IRBDescriptor.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract RBDescriptor is IRBDescriptor {
    struct Color {
        string value;
        string name;
    }
    ...
    function tokenURI(
        ...
        string
            memory description = "Rabbit Bounching is fully onchain NTFs, no IPFS or any external storage.  Olny code (x.+)";
